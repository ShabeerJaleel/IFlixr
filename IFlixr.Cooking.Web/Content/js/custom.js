...
//    $('#ri-grid-no-animation').gridrotator({ slideshow: false });
    ...
    $(window).resize(function () {
        ...
        // $(window).resize(function(){
//        $('ul.fredsel').carouFredSel({
//            auto: false,
//            prev: {
//                button: function () { return $(this).parents('.carousel-wrapper').find('a.fredsel-prev'); },
//                key: "left"
//            },
//            next: {
//                button: function () { return $(this).parents('.carousel-wrapper').find('a.fredsel-next'); },
//                key: "right"
//            },
//            width: "100%"
//        });
...
//        if ($(window).width() < 768) {
//            $('ul.fredsel').children().css({
//                width: $('ul.fredsel').parent().width(),
//                float: 'left'
//            });
